    ...
    <form method="POST" action="{{ route('cashiers.store') }}" enctype="multipart/form-data">
      ...
      <div class="modal-content" style="border-radius: 12px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);">
        <div class="modal-header" style="background: linear-gradient(135deg, #ff6600, #e55a00); color: white; border-radius: 12px 12px 0 0; padding: 1.5rem;">
          <h5 class="modal-title" id="modalCreateCashierLabel" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
        ...
        <div class="modal-body" style="padding: 2rem;">
          ...
          <div class="mb-3">
            <label for="employee_code" class="form-label fw-bold" style="color: #495057; font-family: 'Poppins', sans-serif;">
