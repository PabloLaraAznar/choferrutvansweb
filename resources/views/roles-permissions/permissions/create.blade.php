    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content"
            ...
            <div class="modal-header text-white"
                style="background: linear-gradient(135deg, #ff6600, #e55a00); border-radius: 12px 12px 0 0; padding: 1.5rem;">
                <h5 class="modal-title mb-0" id="createPermissionModalLabel"
            ...
            <form id="createPermissionForm" action="{{ route('permissions.store') }}" method="POST"
                ...
                <div class="modal-body" style="padding: 2rem;">
                    <div class="form-group">
                        <label for="createPermissionName" class="form-label"
                            style="font-weight: 600; color: #333; margin-bottom: 0.5rem;">
                            <i class="fas fa-lock mr-1 text-primary"></i> Nombre del Permiso
                        </label>
                        <input type="text" class="form-control" id="createPermissionName" name="name"
                ...
                <div class="modal-footer"
                    ...
                    <button type="submit" class="btn text-white"
                        style="background: linear-gradient(135deg, #ff6600, #e55a00); border: none; border-radius: 6px; padding: 0.5rem 1.5rem; font-weight: 600;">
